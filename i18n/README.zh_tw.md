...
我是華中師範大學電子資訊科學與技術專業的大學本科生。

我熱衷於建構事物、理解它們的工作原理，並透過實踐來學習。目前，我的大部分時間都花在探索 AI、大語言模型、軟體工程和嵌入式系統上。

我喜歡把有趣的想法變成真正的專案。無論是一個小型開發者工具、一個嵌入式實驗，還是一個 AI 工作流，我不僅想了解它*如何*工作，還想了解它*為什麼*這樣設計。
...
我喜歡嘗試新想法、閱讀原始碼，並建構能夠解決日常開發中實際問題的小專案。
...
| 專案 | 描述 |
| :--- | :--- |
| [Telegodex](https://github.com/AonoChano/telegodex) | 從 Telegram 遠端執行和管理 Codex、Claude Code 等程式設計智慧體。 |
| [KORT](https://github.com/AonoChano/knights-of-round-table) | 一個實驗性框架，多個 AI 專家在此協作、辯論並共同解決問題。 |
| [ClaudeSwitchTUI](https://github.com/AonoChano/claude-switch-tui) | 安全切換 Claude Code 提供商的多語言 TUI 工具，支援作業系統金鑰庫整合和隔離啟動環境。 |
...
除了程式設計，我還喜歡動漫、科幻小說，以及探索新技術如何改變人們建構軟體的方式。

我很高興與大家交流關於 AI、開源或任何有趣事物的想法。
...
<p align="center">
  <em>“前天我看見了一隻兔子，昨天看見了一隻鹿，而今天，我看見了你。”</em>
</p>
